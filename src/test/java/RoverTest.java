...
public class RoverTest {
    ...
    @Test
    public void should_return_east_xmoins1_y0_when_it_go_right_since_the_position_x0_y0_east(){
        PointRover positionInitial=new PointRover(0,0);
    ...
    @Test
    public void should_return_east_x0_y0_when_it_go_left_since_the_position_x0_y0_south(){
        PointRover positionInitial=new PointRover(0,0);
        Rover roverInitial=new Rover(positionInitial,  ""+Direction.S);
    ...
    @Test
    public void should_return_north_x0_y0_when_it_go_left_since_the_position_x0_y0_east(){
        PointRover positionInitial=new PointRover(0,0);
        Rover roverInitial=new Rover(positionInitial,  ""+Direction.E);
